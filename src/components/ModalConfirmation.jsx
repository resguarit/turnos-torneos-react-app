            ...
            <div className="z-50 fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center font-inter">
              <div className="bg-white text-black z-20 p-4 rounded-xl shadow-lg w-11/12 md:w-1/3">
                ...
                <div className="flex justify-evenly">
                    <button
                        onClick={onCancel}
                        className="px-4 py-2 bg-white text-naranja border-2 border-naranja font-semibold lg:text-2xl"
                    ...
                    <button
                        onClick={onConfirm}
                        className="px-4 py-2 bg-naranja font-semibold text-white lg:text-2xl"
                        style={{ borderRadius: "8px" }}
                    >
                        {botonText2}
                    </button>
