...
import { Trash2, Users, MapPin, User, DollarSign, Edit2 } from "lucide-react"; // ADD Edit2
...
const TarjetaGrupoClasesFijas = ({
  ...
  handleEditGrupoClasesFijas, // NEW PROP
  isSaving
}) => {
  const clase = grupo[0];
    ...
    <li className="bg-white rounded-xl shadow border border-gray-200 p-6 flex flex-col gap-2">
      <div className="flex items-center gap-3 mb-1">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => handleEditGrupoClasesFijas(grupo)}
