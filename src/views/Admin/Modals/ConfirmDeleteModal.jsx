...
export default function ConfirmDeleteModal({ isOpen, onClose, onConfirm, loading, accionTitulo, accion, pronombre, entidad, accionando, nombreElemento }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-[8px] shadow-lg w-[90%] max-w-md">
        ...
        <p className='mb-6 text-red-600'>Esta acción no se puede deshacer.</p>
