...
const PestanaPersonas = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-4">
      ...
      {!loading && agregando && (
        <form onSubmit={editando ? handleEditPersona : handleAddPersona} className="mb-6 bg-white p-4 rounded-[8px] shadow">
          <h2 className="text-xl font-bold mb-1">{editando ? 'Editar Persona' : 'Crear Nueva Persona'}</h2>
