    ...
    <div>
      <div className="flex gap-4 mb-4 mt-8">
        <Button
          ...
          className={`px-4 py-2 rounded-[8px] ${activeView === 'turnos' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
        >
          Ver Turnos
        </Button>
        <Button
          ...
          className={`px-4 py-2 rounded-[8px] ${activeView === 'grilla' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'}`}
        >
          Ver Grilla
        </Button>
      </div>
