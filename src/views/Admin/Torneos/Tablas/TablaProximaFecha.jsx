          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="bg-black text-white">
                <th className="py-2 px-3 text-left font-medium">Local</th>
                <th className="py-2 px-3 text-center font-medium">vs</th>
                <th className="py-2 px-3 text-left font-medium">Visitante</th>
                <th className="py-2 px-3 text-center font-medium">Cancha</th>
                <th className="py-2 px-3 text-center font-medium">Hora</th>
              </tr>
            </thead>
            <tbody>
              {partidos.map((partido, index) => (
                <tr key={partido.id || index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  <td className="py-2 px-3 text-gray-600">{getTeamName(partido, partido.equipo_local_id)}</td>
