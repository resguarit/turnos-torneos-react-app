...
export function TabFechas({ zona, fechas, fechaInicial, setFechaInicial, calendarOpen, setCalendarOpen, calendarRef, handleSortearFechas, loading, zonaId, setFechasSorteadas, setFechas  }) {
