export function TabGrupos({zona, grupos, numGrupos, setNumGrupos, handleActualizarGrupos, handleEliminarEquipoDeGrupo, editMode, setModalVisible, gruposCreados}) {
    return (
        <div>
            <div className="mt-6">
              <div className="mb-4">
