...
const zonas = [
  ...
  { id: 4, name: 'LIGA D 2024', format: 'Fase de Grupos', diaProximo: 'Domingo 21', horarioProximo: '18:00hs', count: 12 },
]
      ...
      <main className="flex-1 p-6 bg-gray-100">
        ...
        <div className="max-w-7xl lg:max-w-full mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/alta-zona" className="bg-black hover:bg-black/80 p-3 lg:text-[1.4rem] font-inter text-white" style={{ borderRadius: '8px' }}>
              + Nueva Zona
            </Link>
          </div>
