      ...
      <main className="flex-grow flex items-center justify-center bg-gray-100 px-4">
        <div className="max-w-2xl w-full text-center">
          <div className="mb-8">
            ...
            >
              <circle cx="100" cy="100" r="96" fill="#FF5533" fillOpacity="0.1" />
              <path
          ...
          <Button className="bg-[#FF5533] hover:bg-[#FF5533]/90 text-white font-bold py-3 px-6 rounded-full text-lg">
            <Link to="/">
              Volver al inicio
            </Link>
          </Button>
